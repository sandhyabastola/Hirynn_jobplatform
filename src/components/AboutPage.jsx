...
const stats = [
  { number: "140+", label: "Schools Connected" },
  { number: "500+", label: "Teachers Empowered" },
  { number: "1000+", label: "Successful Matches" },
  { number: "95%", label: "Successful Rate" },
]
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8">
        ...
        <div className="lg:w-1/2">
          ...
          <p className="italic text-gray-600 text-left max-w-3xl">
            ...
            opportunities, helping schools and institutions find the talent they
            need to inspire the next generation. By shaping futures together, we aim
      ...
      <div className="w-full flex items-center justify-center text-center px-8">
        <p className="text-gray-700 text-lg leading-relaxed max-w-2xl">
          ...
          strive to create meaningful opportunities where teachers feel valued
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2 space-y-6 text-gray-700">
              ...
              <p className="text-lg">
                At Hirynn, our mission is to empower educators and institutions
                by providing a trusted platform that connects passionate
                teachers with meaningful opportunities. We strive to enhance the
                educational landscape by fostering transparency, fairness, and
                trust in every interaction. Our goal is to support the growth
                and success of both teachers and schools, ultimately contributing
                to a brighter future for learners everywhere.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mt-4">
              Our dedicated team is passionate about connecting educators with
              the right opportunities and supporting institutions in their
              search for top talent. Together, we are committed to making a
              positive impact on the educational landscape.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-foreground">
            Join The Hirynn Community
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mt-4">
            At Hirynn, we believe that every student deserves the right teacher
            and every teacher deserves the right opportunity. Together, we are
            shaping a future of education.
          </p>
          <Button
            size="lg"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg text-muted-foreground">
              Stay Connected with Hirynn — Get The Latest Jobs And Career Tips
